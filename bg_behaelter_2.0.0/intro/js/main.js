...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
function suche_sprung(search_page) {
	if (top.allow_search) {
		if (suchfenster) {
			if (!suchfenster.closed) { // das Suchfenster wurde noch nicht wieder geschlossen
				suchfenster.location.href="../search_frameset.htm?"+search_page;
				suchfenster.focus();
			} else {					// Suchfenster wurde vom Benutzer geschlossen
				suchfenster = window.open("../search_frameset.htm?"+search_page,"suchfenster","width=450,height=640,screenX=10,screenY=10,status=yes,scrollbars=auto,resizable=no,menubar=no");
			}
